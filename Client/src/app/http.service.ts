...
export class HttpService {
  ...
  public getAllProducts = ()=>{
    return this._http.get(`api/v1/wines/get/all?authToken=${this.cookieService.get('authToken')}`)
  }

  public getProductByCountry =(name) =>{
    return this._http.get(`api/v1/wines/get/country/${name}?authToken=${this.cookieService.get('authToken')}`)
  }

  public getProductByRegion1 =(name) =>{
    return this._http.get(`api/v1/wines/get/region_1/${name}?authToken=${this.cookieService.get('authToken')}`)
  }

  public getProductByRegion2 =(name) =>{
    return this._http.get(`api/v1/wines/get/region_2/${name}?authToken=${this.cookieService.get('authToken')}`)
  }

  public getProductByProvince =(name) =>{
    return this._http.get(`api/v1/wines/get/province/${name}?authToken=${this.cookieService.get('authToken')}`)
  } 

  public getProductByVariety =(name) =>{
    return this._http.get(`api/v1/wines/get/variety/${name}?authToken=${this.cookieService.get('authToken')}`)
  }
